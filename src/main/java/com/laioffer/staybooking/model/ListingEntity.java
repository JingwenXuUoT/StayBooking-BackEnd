...
public class ListingEntity {
    ...
    private Long id;
    @Column(name = "host_id")//foreign key
    private Long hostId;
    private String name;
    private String address;
    private String description;
    private Integer guestNumber;
    private List<String> imageUrls;//no @ElementCollection originally
    private Point location;

    @ManyToOne//one host, many bookings
    @OnDelete(action = OnDeleteAction.CASCADE)
    @JoinColumn(name = "host_id", foreignKey = @ForeignKey(name = "fk_listing_host"), insertable = false, updatable = false)//host if a list is immutable
